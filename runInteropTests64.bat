...
cd %RUNTIME_ROOT%
.\dotnet.cmd build -bl %RUNTIME_ROOT%\src\libraries\System.Runtime.InteropServices.JavaScript\tests\System.Runtime.InteropServices.JavaScript.UnitTests\System.Runtime.InteropServices.JavaScript.Tests.csproj /t:Test /p:InvariantGlobalization=true /p:TargetOS=browser /p:TargetArchitecture=wasm /p:Scenario=WasmTestOnChrome /p:EmccExtraCFlags=-sUSE_CLOSURE_COMPILER=1 /p:EmccExtraLDFlags=-sUSE_CLOSURE_COMPILER=1 

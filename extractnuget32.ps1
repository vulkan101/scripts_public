...
$sourceDirectory = "C:\xr_dev\dotnetFork32\runtime\artifacts\packages\Debug\Shipping"
$destinationRoot = "C:\xr_dev\dotnetFork32\runtime\artifacts\packages\Debug\Shipping\Extracted"
